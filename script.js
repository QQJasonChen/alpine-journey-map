...
const days=[
  ...
  {date:'2026-08-01',label:'Murmelweg、Zum See、國慶',note:'自然步道與村內活動',events:[['清晨','Murmelweg','起初找不到入口，確認路線後看到多隻野生阿爾卑斯土撥鼠。','murmelweg'],['中午','Zum See 附近吊橋','先前往 Restaurant Zum See 附近的吊橋。沿途與橋上視野很好；吊橋名稱待確認。','zum-see'],['午餐','Restaurant Zum See','走完吊橋後用餐，點了羊肉、Sauvignon Blanc 與馬鈴薯。','zum-see'],['晚上','Swiss National Day','策馬特街區出現瑞士國旗、音樂與節慶活動。','zermatt']]},
