...
const places = [
  ...
  {id:'oeschinensee',name:'Oeschinensee',zh:'厄希嫩湖一日遊',date:'2026-07-29',country:'瑞士',cat:'景點',lat:46.4986,lng:7.7268,desc:'經 Kandersteg 前往厄希嫩湖。纜車票需要預先處理；當天忘了購票，因此徒步上山約 1.5–2 小時。先走訪湖區附近的吊橋，再前往湖邊；晚上繼續移動到策馬特。',maps:'https://www.google.com/maps/search/?api=1&query=Oeschinensee%2C%20Switzerland',photo:'images/oeschinensee.jpg'},
...
const days=[
  ...
  {date:'2026-07-29',label:'Oeschinensee → Zermatt',note:'徒步上山、湖區與長距離移動',events:[['上午','Kandersteg → Oeschinensee','纜車票需要提前購買；當天忘了買，因此改成徒步上山，約走 1.5–2 小時。','oeschinensee'],['中午','湖區附近吊橋','抵達湖區後先去附近吊橋。沿途視野開闊、景色很好；吊橋名稱待確認。','oeschinensee'],['午後','Oeschinensee 湖邊','這個地點由瑞士當地人推薦。抵達後在湖邊停留，再準備下山與後續移動。','oeschinensee'],['晚上','抵達 Zermatt','結束厄希嫩湖行程後，當晚直接入住策馬特。','zermatt']]},
  ...
  {date:'2026-08-01',label:'Murmelweg、Zum See、國慶',note:'自然步道與村內活動',events:[['清晨','Murmelweg','起初找不到入口，確認路線後看到多隻野生阿爾卑斯土撥鼠。','murmelweg'],['午餐','Restaurant Zum See','羊肉、Sauvignon Blanc 與馬鈴薯。','zum-see'],['晚上','Swiss National Day','策馬特街區出現瑞士國旗、音樂與節慶活動。','zermatt']]},
